...
class FxCtrl : public CViewContainer, public CControlListener
...
public:
	// return which of our (if any) controls has focus or -1 for nothing (matches BlkFxParam param numbers)
