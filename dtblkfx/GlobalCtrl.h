...
class GlobalCtrl : public CViewContainer, public CControlListener
// global controls
{
public:
...
public: //override virtual methods from CControlListener (so we can get events from the pop-up menus)
...
public: // internal stuff
	...
	int getBlkSzPlan() { return limit_range((int)(_blksz->getValue()*NUM_FFT_SZ), 0, NUM_FFT_SZ-1); }
