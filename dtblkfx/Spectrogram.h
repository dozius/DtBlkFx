...
public: // initialization routines that MUST be called before use
	...
	void setName(const char* name) { _name = name; _name_dirty = true; }
	...
	// supply new FFT data
	void newData(
		cplxf** bin_rng,	// appropriate bin rng's from PixelFreqBin (must match pix_freq passed to init)
