...
public:
	...
	FxRun1_0(const char* name = "?")
	{
		...
		for(int i = 0; i < BlkFxParam::NUM_FX_PARAMS; i++) _params_used[i] = true;
	}
	...
	virtual Rng<char> /*updated rng*/ dispVal(FxState1_0* s, Rng<char> /*out*/text, float/*0..1*/val)
		{ return text << "-"; }
...
public: // methods for the GUI
	...
	{
		if(!idx_within(idx, _value_presets)) return NULL;
